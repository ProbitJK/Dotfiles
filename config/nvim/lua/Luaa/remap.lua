...
vim.keymap.set("n", "<C-s>", ":w<CR>", {desc = 'Save file in buffer'})
vim.keymap.set("i", "<C-s>", "<Esc>:w<CR>", {desc = 'Save file in buffer'})
...
vim.keymap.set("n", "<leader>sp", ":vsplit<CR><C-w>w:Ex<CR>", {desc = 'Split the current tab vertically and open file explorer on the right'})
